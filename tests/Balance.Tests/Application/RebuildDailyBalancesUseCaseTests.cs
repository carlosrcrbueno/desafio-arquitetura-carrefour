...
public class RebuildDailyBalancesUseCaseTests
{
    ...
    public async Task ExecuteAsync_DeveReconstruirSaldos()
    {
        ...
        {
            new(Guid.NewGuid(), accountId, 100m, TransactionType.Credit, new DateTime(2026, 1, 1, 10, 0, 0)),
            new(Guid.NewGuid(), accountId, 50m, TransactionType.Debit, new DateTime(2026, 1, 1, 12, 0, 0)),
            new(Guid.NewGuid(), accountId, 25m, TransactionType.Credit, new DateTime(2026, 1, 2, 9, 0, 0))
        };
        ...
        var day1 = all.FirstOrDefault(b => b.Date == new DateOnly(2026, 1, 1));
        var day2 = all.FirstOrDefault(b => b.Date == new DateOnly(2026, 1, 2));
